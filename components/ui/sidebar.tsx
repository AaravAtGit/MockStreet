...
import { type HTMLAttributes, type ReactNode, type CSSProperties, forwardRef } from "react"
...
/**
 * Configuration constants for the sidebar component
 */
...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(
  ({ className, children, open: openProp, onOpenChange: setOpenProp, ...props }, ref) => {
